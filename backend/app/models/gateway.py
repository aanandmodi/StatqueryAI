...
class DemoSpecialistGateway:
    ...
    async def infer(
        ...
        answers = {
            TaskType.SINGLE_VQA: (
                "### Simulated single-image response\n\n"
                "This placeholder proves the API and UI contract only. No pixels were inspected "
                "and no visual claim, location, score, or boundary in this response is evidence."
            ),
            TaskType.CAPTION: (
                "### Simulated caption response\n\n"
                "This is synthetic integration text. No model inspected the image, so it must not "
                "be cited as a scene description or an accuracy result."
            ),
            TaskType.GROUNDING: (
                f"### Simulated grounding response: {target}\n\n"
                "The displayed box is deterministic placeholder geometry. No grounding or "
                "segmentation model ran, and the boundary is not evidence."
            ),
            TaskType.CHANGE_VQA: (
                "### Simulated temporal response\n\n"
                "No learned change model or pixel comparison ran. This placeholder makes no claim "
                "about co-registration, radiometry, change type, extent, or cause."
            ),
            TaskType.OPTICAL_SAR_FUSION: (
                "### Simulated optical/SAR response\n\n"
                "No fusion model or analytical proxy ran. This placeholder does not verify "
                "backscatter, optical features, all-weather performance, or accuracy."
            ),
        }
